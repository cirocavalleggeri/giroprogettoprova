...
public class CircularActivityIndicatorOneTouch extends View {
    ...
    Boolean pressed;
    public CircularActivityIndicatorOneTouch(Context context, AttributeSet
            attributeSet) {
    ...
    public boolean onTouchEvent(MotionEvent event) {
        ...
        switch(event.getAction()) {
            case MotionEvent.ACTION_DOWN:
                ...
                pressed = true;
                cambia_stato_pressed(pressed);
                //invalidate() si usa quando l'aggiornamento viene richiesto dal Thread principale
                // in caso contrario si usa postinvalidate();
                invalidate();
                //ritorniamo true quando vogliamo processare l'evento,ritorniamo  false quando
                //non interessa e lasciamo alla finestra genitore il compito di elaborare l'evento
                return true;
