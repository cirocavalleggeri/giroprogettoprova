package com.example.ciro.terzaapp.draw;
...
public class DrawingView extends View
{
    ...
    protected void onDraw(Canvas canvas)
    {
        ...
        //mDrawCanvas=canvas;
        drawText("String testo",canvas);
    }
    public void drawText(String testo,Canvas canvas)
    {

        mDrawPaint.setColor(Color.WHITE);
        mDrawPaint.setTextSize(60);
        canvas.drawText(testo, 10, 100, mDrawPaint);
